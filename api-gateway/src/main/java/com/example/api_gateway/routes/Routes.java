...
public class Routes {
    ...
    public RouterFunction<ServerResponse> showServiceRoute() {
        return GatewayRouterFunctions.route("show_service")
                .route(RequestPredicates.path("/api/shows/**"), HandlerFunctions.http("http://localhost:8082"))
                .build();
    }
    ...
    public RouterFunction<ServerResponse> bookingServiceRoute() {
        return GatewayRouterFunctions.route("booking_service")
                .route(RequestPredicates.path("/api/bookings/**"), HandlerFunctions.http("http://localhost:8083"))
                .build();
    }
    ...
    public RouterFunction<ServerResponse> paymentServiceRoute() {
        return GatewayRouterFunctions.route("payment_service")
                .route(RequestPredicates.path("/api/payments/**"), HandlerFunctions.http("http://localhost:8084"))
                .build();
    }
}
